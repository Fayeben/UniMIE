...
class GaussianDiffusion_HDR_v1:
    """
    ...
    def condition_score(self, cond_fn, p_mean_var, x, pred_xstart, t, light_factor=None, light_mask=None, corner=None, model_kwargs=None):
        """
        ...
        return out, light_factor, light_mask
    ...
    def p_sample(
        ...
        for (hi, wi) in corners:
            ...
            if cond_fn_short is not None:
                for i in range(1):
                    out, light_factor_tmp, light_mask_tmp = self.condition_score(
                        cond_fn_short, out, x[:, :, hi:hi + p_size, wi:wi + p_size], pred_xstart, t, light_factor = light_factor, light_mask = light_mask[hi:hi + p_size, wi:wi + p_size], corner=[hi, wi, p_size], model_kwargs=model_kwargs
                    )
            ...
            if cond_fn_medium is not None:
                for i in range(1):
                    out, light_factor_tmp, light_mask_tmp = self.condition_score(
                        cond_fn_medium, out, x[:, :, hi:hi + p_size, wi:wi + p_size], pred_xstart, t, light_factor = light_factor, light_mask = light_mask[hi:hi + p_size, wi:wi + p_size], corner=[hi, wi, p_size], model_kwargs=model_kwargs
                    )
                light_mask_return[hi:hi + p_size, wi:wi + p_size] += light_mask_tmp
                light_factor_return += light_factor_tmp
                light_mask_grid_mask[hi:hi + p_size, wi:wi + p_size] += 1
            ...
            if cond_fn_long is not None:
                for i in range(1):
                    out, light_factor_tmp, light_mask_tmp = self.condition_score(
                        cond_fn_long, out, x[:, :, hi:hi + p_size, wi:wi + p_size], pred_xstart, t, light_factor = light_factor, light_mask = light_mask[hi:hi + p_size, wi:wi + p_size], corner=[hi, wi, p_size], model_kwargs=model_kwargs
                    )
                light_mask_return[hi:hi + p_size, wi:wi + p_size] += light_mask_tmp
                light_factor_return += light_factor_tmp
                light_mask_grid_mask[hi:hi + p_size, wi:wi + p_size] += 1
