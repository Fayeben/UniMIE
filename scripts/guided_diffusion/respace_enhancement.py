...
from .gaussian_diffusion_enhancement_anysize import GaussianDiffusion_anysize
from .gaussian_diffusion_enhancement_HDR import GaussianDiffusion_HDR
...
class SpacedDiffusion_anysize(GaussianDiffusion_anysize):
    """
    ...
    def __init__(self, use_timesteps, **kwargs):
        ...
        base_diffusion = GaussianDiffusion_anysize(**kwargs)  # pylint: disable=missing-kwoa
