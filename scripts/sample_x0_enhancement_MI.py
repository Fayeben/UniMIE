...
def main():
    ...
    import shutil
    shutil.copy('/mnt/data/digital_content_aigc/feiben/GDP/scripts/sample_x0_enhancement_low_light_MI.py', save_dir)
    ...
    def light_cond_fn(x, t, light_factor = None, light_mask = None, corner=None, y=None, x_lr=None, sample_noisy_x_lr=False, diffusion=None, sample_noisy_x_lr_t_thred=None):
        ...
        with th.enable_grad():
            ...
            if not x_lr is None:
                ...
                # loss = loss - mse * args.img_guidance_scale  - loss_exp * args.img_guidance_scale * 0.01  - Loss_TV * args.img_guidance_scale # move xt toward the gradient direction
                loss = loss - mse * args.img_guidance_scale - loss_exp * args.img_guidance_scale * 0.01 - Loss_TV * args.img_guidance_scale * 0.001
    ...
    for i, data in enumerate(dataloader):
        ...
        light_mask =  th.rand([512, 512], device=device)/10000
        ...
        light_mask = light_mask.unsqueeze(0).unsqueeze(0).repeat(1,3,1,1).permute(0, 2, 3, 1)*1000
...
def create_argparser():
    defaults = dict(
        ...
        batch_size=1,
        use_ddim=False,
        model_path="/mnt/data/digital_content_aigc/feiben/DDPM_Beat_GAN/scripts/models/256x256_diffusion_uncond.pt",
    )
    ...
    parser.add_argument("--save_dir", default='/mnt/data/digital_content_aigc/feiben/DDPM_Beat_GAN/MD_image/teaser_more/generated_image_x0_enhancement_brightness_RIADD_AMD_512_512_mse_0.01exp0.4_0.001TV_1e5', type=str, help='the directory to save the generate images')
    ...
    parser.add_argument("--dataset_path", default='/mnt/data/digital_content_aigc/feiben/DDPM_Beat_GAN/evaluations/precomputed/biggan_deep_imagenet64.npz', type=str, help='path to the genefrated images. Could be an npz file or an image folder')
    ...
    parser.add_argument("--img_guidance_scale", default=100000, type=float, help='guidance scale')
    parser.add_argument("--base_samples", default='/mnt/data/digital_content_aigc/feiben/DDPM_Beat_GAN/MD_image/teaser_more/RIADD_AMD_512_512_resolution_512.npz', type=str, help='the directory or npz file to the guidance imgs. This folder should have the same structure as dataset_path, there should be a one to one mapping between images in them')
